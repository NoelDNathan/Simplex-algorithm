...
class Simplex():
    ...
    def solve(self, verbose=0, inverse=False):
        ...
        i_B, i_N, x_B, z, inv_B = self.fase_1(verbose, inverse)
        ...
        i_B, i_N, x_B, z, inv_b = self.fase_2(i_B, i_N, x_B, z, inv_B, verbose, inverse, fase_2=True)
    ...
    def fase_1(self, verbose=0, inverse=False):
        ...
        i_B, i_N, x_B, z, inv_B = self.fase_2(i_B, i_N, x_B, z, inv_B, verbose, inverse)
    ...
    def fase_2(self, i_B, i_N, x_B, z, inv_B, verbose=0, inverse=False, fase_2 = False):
